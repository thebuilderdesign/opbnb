                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/v2/${currencyA?.isNative ? WBNB[chainId].address : currencyIdA}/${
                              currencyB?.isNative ? WBNB[chainId].address : currencyIdB
                            }`}
                          >
                            Receive WBNB
                          </StyledInternalLink>
                          ...
                          <StyledInternalLink
                            to={`/remove/v2/${
                              currencyA && currencyEquals(currencyA, WBNB[chainId]) ? 'EVMOS' : currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WBNB[chainId]) ? 'EVMOS' : currencyIdB}`}
                          >
                            Receive EVMOS
                          </StyledInternalLink>
                        ) : null}
